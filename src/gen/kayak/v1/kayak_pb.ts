...
import type { Record, Stream, StreamStats, Worker } from "./model_pb";
...
export const file_kayak_v1_kayak: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_google_protobuf_empty, file_kayak_v1_model, file_kayak_v1_raft]);
...
/**
 * @generated from message kayak.v1.GetStreamStatisticsRequest
 */
export type GetStreamStatisticsRequest = Message<"kayak.v1.GetStreamStatisticsRequest"> & {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
...
/**
 * Describes the message kayak.v1.GetStreamStatisticsRequest.
 * Use `create(GetStreamStatisticsRequestSchema)` to create a new message.
 */
export const GetStreamStatisticsRequestSchema: GenMessage<GetStreamStatisticsRequest> = /*@__PURE__*/
  messageDesc(file_kayak_v1_kayak, 18);

/**
 * @generated from message kayak.v1.GetStreamStatisticsResponse
 */
export type GetStreamStatisticsResponse = Message<"kayak.v1.GetStreamStatisticsResponse"> & {
  /**
   * @generated from field: kayak.v1.StreamStats stream_stats = 1;
   */
  streamStats?: StreamStats;
};

/**
 * Describes the message kayak.v1.GetStreamStatisticsResponse.
 * Use `create(GetStreamStatisticsResponseSchema)` to create a new message.
 */
export const GetStreamStatisticsResponseSchema: GenMessage<GetStreamStatisticsResponse> = /*@__PURE__*/
  messageDesc(file_kayak_v1_kayak, 19);
...
export const KayakService: GenService<{
  ...
  /**
   * @generated from rpc kayak.v1.KayakService.GetStreamStatistics
   */
  getStreamStatistics: {
    methodKind: "unary";
    input: typeof GetStreamStatisticsRequestSchema;
    output: typeof GetStreamStatisticsResponseSchema;
  },
  /**
   * Raft Specific
   *
