...
const (
	...
	// RaftTransportRequestPreVoteProcedure is the fully-qualified name of the RaftTransport's
	// RequestPreVote RPC.
	RaftTransportRequestPreVoteProcedure = "/transport.v1.RaftTransport/RequestPreVote"
)
...
type RaftTransportClient interface {
	...
	RequestPreVote(context.Context, *connect.Request[v1.RequestPreVoteRequest]) (*connect.Response[v1.RequestPreVoteResponse], error)
}
...
func NewRaftTransportClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RaftTransportClient {
	...
	raftTransportMethods := v1.File_transport_v1_transport_proto.Services().ByName("RaftTransport").Methods()
	return &raftTransportClient{
		appendEntriesPipeline: connect.NewClient[v1.AppendEntriesRequest, v1.AppendEntriesResponse](
			...
			connect.WithSchema(raftTransportMethods.ByName("AppendEntriesPipeline")),
		...
		installSnapshot: connect.NewClient[v1.InstallSnapshotRequest, v1.InstallSnapshotResponse](
			...
			connect.WithSchema(raftTransportMethods.ByName("InstallSnapshot")),
			connect.WithClientOptions(opts...),
		),
		requestPreVote: connect.NewClient[v1.RequestPreVoteRequest, v1.RequestPreVoteResponse](
			httpClient,
			baseURL+RaftTransportRequestPreVoteProcedure,
			connect.WithSchema(raftTransportMethods.ByName("RequestPreVote")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type raftTransportClient struct {
	...
	requestPreVote        *connect.Client[v1.RequestPreVoteRequest, v1.RequestPreVoteResponse]
}
...
// RequestPreVote calls transport.v1.RaftTransport.RequestPreVote.
func (c *raftTransportClient) RequestPreVote(ctx context.Context, req *connect.Request[v1.RequestPreVoteRequest]) (*connect.Response[v1.RequestPreVoteResponse], error) {
	return c.requestPreVote.CallUnary(ctx, req)
}
...
func NewRaftTransportHandler(svc RaftTransportHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	raftTransportRequestPreVoteHandler := connect.NewUnaryHandler(
		RaftTransportRequestPreVoteProcedure,
		svc.RequestPreVote,
		connect.WithSchema(raftTransportMethods.ByName("RequestPreVote")),
		connect.WithHandlerOptions(opts...),
	)
	return "/transport.v1.RaftTransport/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case RaftTransportRequestPreVoteProcedure:
			raftTransportRequestPreVoteHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedRaftTransportHandler) RequestPreVote(context.Context, *connect.Request[v1.RequestPreVoteRequest]) (*connect.Response[v1.RequestPreVoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("transport.v1.RaftTransport.RequestPreVote is not implemented"))
}
